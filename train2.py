...
from model.CMASRec2 import CMASRec2
...
class Recommender(object):
    ...
    def _initialize(self, interactions):
        ...
        self._net = CMASRec2(self._num_users,
                         self._num_items,
    ...
    def fit(self, train, verbose=False):
        ...
        for epoch_num in range(start_epoch, self._n_iter):
            ...
            if verbose and (epoch_num + 1) % 1 == 0:
                ...
                torch.save(self._net, "datasets/{}/MACSRec2_".format(DATASET_NAME) + str(epoch_num + 1) + ".model")
            else:
...
if __name__ == '__main__':
    ...
    log_file_name = "datasets/{}/{}_r{}_MACSRec2_b5_l{}_bs{}_W{}_kld1{}_kld2{}_kld3{}.txt".format(config.dataset,
                                                                                                config.dataset,
                                                                                                config.seed,
                                                                                                config.L,
                                                                                                config.batch_size,
